...
public class BoardController {
    ...
    @GetMapping("/board/write/image")   ///localhost:8090/board/write
    public String boardWriteForm()
    {
        return "boardwrite";
    }

    @GetMapping("/board/write/person")
    public String boardWriteperson() {return "person";}

    @GetMapping("board/write/background")
    public String boardWritebackground() {return "person";}
